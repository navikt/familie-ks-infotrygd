...
CREATE TABLE INFOTRYGD_Q0.KS_STONAD_20
(
...
(
    ...
    KILDE_IS         VARCHAR2(12 CHAR) DEFAULT ' '               NOT NULL,
    REGION           CHAR(1)           DEFAULT ' '               NOT NULL,
    ID_BARN          NUMBER            DEFAULT NOT NULL,
    OPPDATERT        TIMESTAMP(6)      DEFAULT current_timestamp,
    DB_SPLITT        CHAR(2)           DEFAULT 'KS'
);

CREATE TABLE INFOTRYGD_Q0.KS_UTBETALING_30
(
    K01_PERSONKEY           NUMBER(15, 0)                               NOT NULL,
    ...
    KILDE_IS                VARCHAR2(12 CHAR) DEFAULT ' '               NOT NULL,
    REGION                  CHAR(1)           DEFAULT ' '               NOT NULL,
    ID_UTBET                NUMBER            DEFAULT NOT NULL,
    OPPDATERT               TIMESTAMP(6)      DEFAULT current_timestamp,
    DB_SPLITT               CHAR(2)           DEFAULT 'KS'
);